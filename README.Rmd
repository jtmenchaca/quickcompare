...
By default, the binary/categorical columns are compared across groups using the Fisher's Exact Test.  If the data is too large to be run efficiently using the standard Fisher's Exact Test, comparisons will be made using the Monte Carlo test for Fisher's.
