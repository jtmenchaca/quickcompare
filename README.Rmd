...
Nearly every abstract/poster/publication will need fine-tuning of results table prior to truly being "publication-ready".  As a first step along that path, you can use `quickcompare` to neatly translate your formatted results into an XLSX file with `save_comparison_to_xlsx()`.
